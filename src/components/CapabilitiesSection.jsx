          ...
          <div className="hidden sm:flex flex-row items-start gap-2 sm:gap-3 md:gap-4">
            ...
            <div className="w-full sm:flex-1 flex flex-col items-start text-left sm:w-auto">
              <motion.h1
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.05 }}
                className="capabilities-gradient-text font-semibold leading-[1.2] tracking-tight mb-1 sm:mb-3 md:mb-4 lg:mb-6 text-[16px] sm:text-[24px] md:text-[32px] lg:text-[50px]"
              >
                {homePage?.capabilities_title || "Our Engineering"}
                <br />
                Capabilities
              ...
              {capabilities.map((capability, index) => (
                ...
                >
                  <Card className="relative w-full h-full flex flex-col items-center justify-center gap-0.5 sm:gap-2 md:gap-1.5 p-1.5 sm:p-3 md:p-2.5 hover:shadow-lg transition-all duration-300 bg-white border border-gray-200 hover:border-orange-500/50 hover:shadow-orange-100/50 overflow-hidden">
                    ...
                    <h3 className="text-center text-[1px] sm:text-sm md:text-[6px] lg:text-sm font-semibold text-foreground leading-tight px-0.5">
                      {capability.title}
                    </h3>
                  </Card>
                </motion.div>
